    ...
    timeline: [
      {
        ...
        actorRole: 'Citizen',
        note: 'Report submitted via AapdaSetu mobile web. GPS confirmed.'
      },
      {
        id: 'tl-2',
        status: 'Verified',
