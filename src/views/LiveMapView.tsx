...
import { MapPin, Filter, PlusCircle, Search, Flame, ShieldAlert, Navigation, RefreshCw, Compass, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2 border-t border-slate-100">
          ...
          <form onSubmit={handleSearchLocation} className="flex items-center space-x-2">
            ...
            >
              {isSearching ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : <span>Go</span>}
            </button>
          </form>
        </div>
